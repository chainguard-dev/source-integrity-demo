...
git config --local gitsign.matchCommitter true # Detect (earlier than PR) that you didn't sign with the correct browser window (OIDC) - enabling this will warn you when you commit
